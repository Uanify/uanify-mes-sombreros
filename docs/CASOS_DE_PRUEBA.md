...
* **Pasos:** 1. Escanear Lote `49,633`. 2. Pulsar `✂️ Fraccionar Lote Madre en 4 Sublotes`. 3. Confirmar.
...
* **Resultado Esperado:** La tarjeta de D-05 parpadea en rojo con la leyenda: `⚠️ SATURACIÓN WIP (75 / 70 pzas)`.
* **Estatus:** `[✅ Pasa - v2.18.0]`
...
* **Resultado Esperado:** Se visualiza la línea con pasos completados (✅), estación activa (`📍 AQUÍ ESTÁ EL LOTE`) y paradas pendientes.
* **Estatus:** `[✅ Pasa - v2.18.0]`
...
* **Pasos:** 1. Pulsar botón `⏮️ Regresar Lote a Estación Previa`. 2. Seleccionar motivo: `Retrabajo de prensado`.
...
* **Resultado Esperado:** Semáforo rojo pulsante visible a distancia con texto `⚠️ SATURACIÓN / PARO INMINENTE`.
* **Estatus:** `[✅ Pasa - v2.18.0]`
...
* **Resultado Esperado:** El tablero indica `🍽️ RECESO DE ALMUERZO (Línea en Pausa Programada)` y el cronómetro de Takt se congela.
* **Estatus:** `[✅ Pasa - v2.18.0]`
...
* **Pasos:** 1. En Andon, hacer clic en `🖥️ Pantalla Completa`.
...
* **Resultado Esperado:** La barra de desgaste se colorea en rojo parpadeante con leyenda: `⚠️ RECTIFICACIÓN REQUERIDA (102.4%)`.
* **Estatus:** `[✅ Pasa - v2.18.0]`
...
* **Resultado Esperado:** Pastilla roja pulsante: `⚠️ STOCK CRÍTICO (18 pzas)`.
* **Estatus:** `[✅ Pasa - v2.18.0]`
...
* **Pasos:** 1. En orden liberada, pulsar `🖨️ Generar Tarjeta Viajera`.
